...
- (void) _loadImages
{
    ...
    [_webView evaluateJavaScript:@"findCIDImageURL()" completionHandler:^(id result, NSError * _error){
        ...
        for(NSString * urlString in imagesURLStrings) {
            ...
            void (^replaceImages)(NSError *error) = ^(NSError *error) {
                ...
                [self->_webView evaluateJavaScript:replaceScript completionHandler:nil];
            };
